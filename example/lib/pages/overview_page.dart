...
/// The component gallery: every widget in the library, on one scrollable page.
class KumoExampleOverview extends StatefulWidget {
  /// Creates the gallery screen.
  const KumoExampleOverview({super.key});

  @override
  State<KumoExampleOverview> createState() => _KumoExampleOverviewState();
}

class _KumoExampleOverviewState extends State<KumoExampleOverview> {
  ...
  Widget build(BuildContext context) {
    ...
    return KumoScaffold(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          const ExampleSectionLabel('Theme'),
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Segmented control'),
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Text input'),
          KumoInput(
            label: 'Api token',
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Toggle'),
          Row(
            children: [
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Accordion'),
          const KumoAccordion(
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('List group'),
          KumoListGroup(
            title: 'Zone settings',
            children: [
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Resource grid'),
          KumoDataGrid(
            maxColumns: 3,
            children: [
              const KumoDataCard(
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Responsive split'),
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Breadcrumb'),
          KumoBreadcrumb(
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Tabs'),
          KumoTabs(
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Badges'),
          const Wrap(
            spacing: 8,
            runSpacing: 8,
            children: <Widget>[
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Checkbox and select'),
          KumoCheckbox(
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Pagination'),
          KumoPagination(
            currentPage: _page,
            totalPages: 5,
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Bottom sheet'),
          KumoButton(
            label: 'Zone actions',
            variant: KumoButtonVariant.secondary,
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Toast'),
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: <Widget>[
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Code block'),
          const KumoCodeBlock(
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Palette'),
          Wrap(
            spacing: 12,
            runSpacing: 12,
            children: <Widget>[
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Primitives'),
          ...
          const SizedBox(height: 12),
          const KumoSensitiveInput(label: 'Api token', placeholder: 'Paste a token'),
          const SizedBox(height: 12),
          KumoRadio<String>(
            value: 'standard',
            groupValue: 'standard',
          ...
          const SizedBox(height: 28),
          const ExampleSectionLabel('Modal'),
          KumoButton(
            label: 'Open dialog',
